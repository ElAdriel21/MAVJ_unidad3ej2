...
void Game::InitPhysics()
{
	...
	circuloA->SetTransform(b2Vec2(50.0f, 10.0f), 0.0f);

	b2Body* circuloB = Box2DHelper::CreateCircularDynamicBody(phyWorld, 5, 1.0f, 0.5, 0.1f);
	circuloB->SetTransform(b2Vec2(80.0f, 10.0f), 0.0f);

	Box2DHelper::CreateDistanceJoint(phyWorld, circuloA, circuloA->GetWorldCenter(),
		circuloB, circuloB->GetWorldCenter(), 10.0f, 0.1f, 1.0f);
}
